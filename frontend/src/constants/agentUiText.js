...
export const AGENT_UI = {
  ...
  scopeAttachRemoveKnowledge: '移出知识点',
  scopeAttachRemoveTitle: '移出题目',
  scopeAttachRemoveDataset: '移出查询结果',
  scopeAttachRemoveView: '移出视图快照',
  scopeAttachRemoveReport: '移出报告',
  scopeAttachHint: '范围与附件可逐项移除；题目视图可「加入对话」',
  scopeAttachAddView: '带上当前视图',
  scopeAttachAddReport: '继续编辑报告',
  scopeAttachAddToChat: '加入对话',
  runAttachQuery: '附到对话',
  ...
  runCancel: '取消',
  runModifyQuery: '改查询',
  runModifyAggregate: '改统计',
  runModifyProcess: '修改计算',
  runDerivedFrom: '基于',
  runSuperseded: '已被替换',
  runStatusRunning: '执行中',
  runStatusSuperseded: '已替换',
