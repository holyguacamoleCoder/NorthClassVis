...
本报告为**全量 37 场景 / 111 session-runs**指标，不是增量小报告。

| 来源 | run_id |
|------|--------|
| 基线（完整跑） | `20260720T072730Z-e671148f` |
| 覆盖层1（部分重跑，跳过 0-token） | `20260720T120400Z-ac2491b4` |
| 覆盖层2（余额不足补跑） | `20260720T122344Z-97702c40` |

合并规则：同一 `(scenario_id, run_index)` 后层覆盖前层；余额不足产生的空跑不覆盖有效结果；随后按当前 fixture 离线重判。
