...
EXPLORATION_THRASH_WINDOW = max(2, int(os.environ.get("AGENT_EXPLORATION_THRASH_WINDOW", "3")))
EXPLORATION_PEEK_LIMIT = max(1, int(os.environ.get("AGENT_EXPLORATION_PEEK_LIMIT", "50")))
