...
FIELD_RESOURCE_HINTS: dict[str, str] = {
    ...
    "score": "submit_record（得分）或 title_info（题目满分；在 submit_record 上已挂为 full_score）",
    "full_score": "submit_record（由 title_info.score 左连接挂载的题目满分）",
    "score_rate": "submit_record（score/full_score，单次提交正确率）",
